            ...
            <div class="card shadow-sm h-100 room-sidebar-card">
                ...
                <div class="card-body p-0">
                    <div class="p-3 border-bottom room-search-area">
                        <div class="neon-search-wrap text-search-wrap"><i class="fas fa-search"></i><input type="text" id="textRoomSearch" class="form-control" placeholder="Search rooms..."></div>
                    </div>
...
<script type="module">
    ...
    async function sendQuickLoginLink(email, name = '') {
        const response = await fetch('chatroom_email.php', {
            method: 'POST',
    ...
    async function handleLoginTokenSignIn() {
        ...
        try {
            ...
            const response = await fetch('verify-login-token.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    function renderCurrentUser() {
        ...
        if (createRoomBtn) {
            if (!currentUser.isAnonymous && hasPrivateRoomAccess) createRoomBtn.classList.remove('d-none');
            else createRoomBtn.classList.add('d-none');
        }
